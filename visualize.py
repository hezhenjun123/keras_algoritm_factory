...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='tools to extract cpu, gpu and mem usage')
    parser.add_argument('-s', '--start', metavar='start_time_stamp', required=False, dest='start_time', action='store')
    parser.add_argument('-e', '--end', metavar='end_time_stamp', required=False, dest='end_time', action='store')
    parser.add_argument('-i', '--input', metavar='input_log_file', required=True, dest='log_file_path', action='store')
    parser.add_argument('-o', '--output', metavar='output_xls_file', required=False, dest='xls_file_path', action='store')
